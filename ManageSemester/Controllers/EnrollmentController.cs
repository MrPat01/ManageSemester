...
namespace ManageSemester.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        public ActionResult Create(int? id)
        {
            ...
            ViewBag.CourseID = new SelectList(db.Courses.Where(c => c.IsApproved == true), "CourseID", "Title");
            ViewBag.StudentID = new SelectList(db.Students.Where(s => s.ID == id.Value), "ID", "FullName");
            return View();
        }
